...
def main_menu():
    ...
    while True:
        ...
        if choice == "1":
            ...
            os.system("Course_Enrollment.py")

        elif choice == "3":

            os.system("Grade_Evaluation.py")

        elif choice == "4":

            os.system("Fee_Calculation.py")

        elif choice == "5":

            os.system("Attend_management.py")

        elif choice == "6":

            os.system(" searchsort.py")

        elif choice == "7":

            os.system("Directory_Scanning.py")

        elif choice == "8":

            os.system("Analytical.py")

        elif choice == "9":

            os.system("AI_Recommend.py")
